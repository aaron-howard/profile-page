	...
	<div class="grid lg:grid-cols-2 gap-12">
		...
		<div class="space-y-8">
			...
			<div class="bg-white rounded-lg shadow-md p-8">
				<h2 class="text-2xl font-semibold text-slate-900 mb-6">Contact Information</h2>
				...
				<div class="space-y-6">
					<div class="flex items-center gap-4">
						...
						<div>
							...
							<p class="text-slate-600">{contactData.name}</p>
						</div>
					</div>
					...
					<div class="flex items-center gap-4">
						...
						<div>
							...
							<a href="mailto:{contactData.email}" class="text-blue-600 hover:text-blue-800">{contactData.email}</a>
						</div>
					</div>
					...
					<div class="flex items-center gap-4">
						...
						<div>
							<h3 class="font-medium text-slate-900">Location</h3>
							<p class="text-slate-600">{contactData.location}</p>
						</div>
					</div>
					...
					<div class="flex items-center gap-4">
						...
						<div>
							...
							<a href="tel:{contactData.phone}" class="text-blue-600 hover:text-blue-800">{contactData.phone}</a>
						</div>
					</div>
				</div>
			</div>
			...
			<!-- Social Links -->
			<div class="bg-white rounded-lg shadow-md p-8">
				<h2 class="text-2xl font-semibold text-slate-900 mb-6">Follow Me</h2>
				
				<div class="grid grid-cols-2 gap-4">
					<a href={contactData.socialLinks.github} class="flex items-center gap-3 p-4 bg-slate-50 rounded-lg hover:bg-slate-100 transition-colors">
						...
						<span class="font-medium text-slate-900">GitHub</span>
					</a>
					
					<a href={contactData.socialLinks.linkedin} class="flex items-center gap-3 p-4 bg-slate-50 rounded-lg hover:bg-slate-100 transition-colors">
						<svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
					...
					<a href={contactData.socialLinks.twitter} class="flex items-center gap-3 p-4 bg-slate-50 rounded-lg hover:bg-slate-100 transition-colors">
						<svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
					...
					<a href={contactData.socialLinks.instagram} class="flex items-center gap-3 p-4 bg-slate-50 rounded-lg hover:bg-slate-100 transition-colors">
						<svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
			...
			<div class="bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg p-8 text-white">
				<h2 class="text-2xl font-semibold mb-4">Current Availability</h2>
		...
		<!-- Contact Form -->
		<div class="bg-white rounded-lg shadow-md p-8">
			<h2 class="text-2xl font-semibold text-slate-900 mb-6">Send Me a Message</h2>
